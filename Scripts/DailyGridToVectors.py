...
monthlyDir = os.path.join(dataDir,"NSIDC","ndisc0116_icemotion_vectors_v3","grid","2014")
templateFN = os.path.join(monthlyDir,'icemotion.grid.daily.{}{}.n.v3.bin')
...
year = str(2014)
day = str(213).zfill(3)
msg("Processing day: {}; year {}".format(day,year))
    
#Output Variables
netFC = os.path.join(scratchDir,"Vectors{}{}.shp".format(year,day))
msg("...Output will be set to: ".format(netFC))

#Get the monthly filename (from the templateFN)
monthlyFN = templateFN.format(year,day)
